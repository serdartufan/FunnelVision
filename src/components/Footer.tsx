    ...
    <footer className="bg-[#1A1A1A] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Diensten */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Diensten</h3>
          ...
          {/* Bedrijf */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Bedrijf</h3>
            <ul className="space-y-3">
              {[
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="/contact"
                  className="inline-block mt-2 bg-[#F5A623] text-white text-sm font-semibold px-4 py-2 rounded-full hover:bg-[#e09520] transition-colors"
                >
                  Gratis kennismaken
                </Link>
              </li>
